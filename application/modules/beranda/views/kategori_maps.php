...
<script type="text/javascript">
	...
	table = $('.kategori').DataTable({ 
		...
		"order": [],
		"ajax": {
			"url": "<?php echo site_url('beranda/ajax_list?type=kategori_maps')?>",
			"type": "POST"
		},
		"columnDefs": [
		{ 
	...
	table_trash = $('.kategori_del').DataTable({ 
		...
		"order": [],
		"ajax": {
			"url": "<?php echo site_url('beranda/ajax_list?type=kategori_maps_del')?>",
			"type": "POST"
		},
	...
	function simpan_data() 
	{
		if(save_method == 'add')
		{
			...
			var url = '<?php echo site_url("beranda/ajax_save?type=kategori_maps"); ?>';
		}
		else
		{
			var data = {
			...
			var url = '<?php echo site_url("beranda/ajax_ubah?type=kategori_maps"); ?>';
		}
	...
	function edit_data(id)
	{
		save_method = 'update';
		$.ajax({
			url : "<?php echo site_url('beranda/ajax_edit?type=kategori_maps')?>",
			type: "post",
			data : {
				id : id,
			},
	...
	function hapus_data(id)
	{
		...
		function(isConfirm){
			if (isConfirm) {
				$.ajax({
					url : '<?php echo site_url("beranda/ajax_hapus?type=kategori_maps"); ?>',
					type: 'post',
					data: {
						id: id
					},
	...
	function restore_data(id)
	{
		...
		function(isConfirm){
			if (isConfirm) {
				$.ajax({
					url: '<?php echo site_url('beranda/ajax_restore?type=kategori_maps'); ?>',
					type: 'post',
					data: {
						id: id
					},
